...
$ambildatasaklar = DB::table('tb_saklar')->get();
?>
	<meta charset="utf-8">
            ...
            <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Saklar Lampu</h3>
                        <p class="animated fadeInDown">
                          Saklar Lampu <span class="fa-angle-right fa"></span> Data Saklar Lampu
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
                       @foreach($ambildatasaklar as $data) 
                            <tr>
                                 <td>{{$data->ID_SAKLAR}}</td>
                                 <td>{{$data->NAMA_SAKLAR}}  </td>
                                
                          @if($data->STATUS_SAKLAR==0)
                                 <td style="background-color: red;color: white; text-align: center;">MATI</td>
                          @else
                          <td style="background-color: green; color: white; text-align: center">HIDUP</td>
                          @endif
                     @endforeach
                     </tr>
                      </tbody>
