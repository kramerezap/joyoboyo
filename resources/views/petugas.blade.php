...
$ambildatapetugas = DB::table('user')->where('LEVEL',2)->get();
?>
	<meta charset="utf-8">
	<meta name="description" content="hutan joyoboyo">
	<meta name="author" content="Khoirul Badarudin">
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Kepala Petugas</span></li>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li>
                      <a href="dashboard"><span class="fa-home fa"></span> Dashboard 
                      </a>
                    </li>
                     <li class="active ripple">
                      <a href="petugas" ><span class="fa-users fa"></span> Petugas 
                      </a>
                    </li>
                     <li>
                      <a href="saklar" ><span class="fa-lightbulb-o fa"></span> Lampu 
                      </a>
                    </li>
                     <li>
                      <a href="log" ><span class="fa-history fa"></span> Log Saklar 
                      </a>
                    </li>
                    </ul>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="tambahpetugas" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Nama Petugas :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="namapetugas" name="namapetugas" placeholder="" required="true">
                  </div>
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Username :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="username" name="username" placeholder="" required="true">
                  </div>
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Password :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="password" name="password" placeholder="" required="true">
                  </div>
...
<div class="modal fade" id="modal-edit{{$data->ID_USER}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" action="updatepetugas={{$data->ID_USER}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card-body">
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Nama Petugas :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="namapetugas" name="namapetugas" value="{{$data->NAMA}}" placeholder="" required="true" >
                  </div>
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Username :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="username" name="username"value="{{$data->USERNAME}}" placeholder="" required="true">
                  </div>
                   <div class="form-group">
                    <br>
                     <label class="col-sm-8 col-sm-8 control-label">Password :</label>
                                        <input type="text" style="width: 100%;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" class="form-control" id="password" name="password" value="{{$data->PASSWORD}}" placeholder="" required="true">
                  </div>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Petugas <span class="fa-angle-right fa"></span> Data Petugas
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading">
                      <button class="btn-primary" data-toggle="modal" data-target="#modal-default">Tambah Petugas</button>
                    <div class="panel-body">
                      ...
                      <tbody>
                       @foreach($ambildatapetugas as $data) 
                            <tr>
                              <td>{{$data->ID_USER}}</td>
                                 ...
                                 <td>{{$data->PASSWORD}}</td>
                                  <td>
                                    ...
                                    <a href="/hapuspetugas={{$data->ID_USER}}"  class="btn btn-danger btn-xs">Hapus
                                    </a>
