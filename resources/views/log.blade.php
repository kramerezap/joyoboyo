            ...
            <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Log Saklar Lampu</h3>
                        <p class="animated fadeInDown">
                          Log Saklar Lampu <span class="fa-angle-right fa"></span>  Data Log Saklar Lampu
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <table id="tampil" class="table table-striped table-bordered" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Nama Saklar</th>
                      ...
                      <tbody>
                      <?php
                          $ambildatalog = DB::SELECT("select*from user a, tb_log b, tb_saklar c where a.ID_USER = b.ID_USER and b.ID_SAKLAR = c.ID_SAKLAR");
                       ?>
                       @foreach($ambildatalog as $data) 
                            <tr>
                               <td>{{$data->ID_LOG}}</td>
                               <td>{{$data->NAMA_SAKLAR}}</td>
                                <td>{{$data->NAMA}}</td>
                                    <td>{{$data->WAKTU_LOG}}</td>
                                        <td>
                                          <?php if($data->AKSI_LOG == 1){ 
                                              echo 'Menghidupkan';
                                           }else if($data->AKSI_LOG == 0){ 
                                              echo 'Mematikan';
                                           } ?>
                                        </td>
