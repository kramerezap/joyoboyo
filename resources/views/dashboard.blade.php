                   ...
                   <ul class="dropdown-menu user-dropdown">
                     ...
                     <li class="more">
                      <ul>
                        ...
                        <li><a href="loguser"><span class="fa fa-power-off "></span></a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
...
<div class="panel">
                  <div class="panel-body">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="col-md-8"> 
                          <h1 style="margin-top: 3%;margin-left:70px;color: grey;">Selamat Datang Kepala Petugas</h1></div>
                        <div class="col-md-2 col-sm-6 text-right" style="padding-left:10px;">
                          <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> Kediri</h3>
